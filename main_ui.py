...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.sidebar_widget.sizePolicy().hasHeightForWidth())
        self.sidebar_widget.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.home_table.sizePolicy().hasHeightForWidth())
        self.home_table.setSizePolicy(sizePolicy)
